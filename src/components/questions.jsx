      ...
      <div className="live_proxies_faqs_main_con">
        <div className="container live_proxies_faqs_con">
          ...
          <h6>
            ...
            if you have questions that are not listed below
          </h6>
          <div
          ...
          >
            {faq.map((item,i) => {
              return (
                <div key={item.title} className="panel panel-default">
                  <div
                    className={
                      open == i ? "panel-heading active" : "panel-heading "
                    }
                    role="tab"
                    id="headingTwo"
                  >
                  ...
                  <div
                    id="collapseTwo"
                    className={
                      open == i ? "panel-collapse " : "panel-collapse collapse"
                    }
                    role="tabpanel"
