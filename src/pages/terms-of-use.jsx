...
export default function RefundPolicy() {
  return (
    ...
    <h3 className="MuiTypography-root jss13 MuiTypography-h3"><b>Terms </b> of use</h3>
    </div>
    </div>
...
<p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights and Live Proxies Inc. aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Information. If you wish to be informed what Personal Information we hold about you and if you want it to be removed from our systems, please contact us. In certain circumstances, you have the following data protection rights:</p>
<ul>
...
<li>You also have the right to withdraw your consent at any time where Live Proxies Inc. relied on your consent to process your Personal Information.</li>
</ul>
...
<p>We may use cookies to collect, store, and track information for statistical purposes to operate the Website and Services. You have the ability to accept or decline cookies. Most web browsers automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. To learn more about cookies and how to manage them, visit&nbsp;<Link href="https://www.internetcookies.org/" target="_blank" rel="noopener">internetcookies.org</Link></p>
...
<h2>Contacting us</h2>
<p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may send an email to <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="4d39282c200d21243b283d3f223524283e632422">[email&nbsp;protected]</a></p>
<p>This document was last updated on November 26, 2020</p>
</div>
</div>
</div>
</div>
